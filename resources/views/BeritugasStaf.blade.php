            ...
            <div class="margin">
                <div class="col-sm-12">
                    <form action="POST">
                        ...
                        <a href="indexStaf.php"><button type="button" class="btn btn-success">Simpan</button></a>
                        <a href="indexStaf.php"><button type="button" class="btn btn-primary">Kembali</button></a>
