...
<body>
    ...
    <div class="container" id="home">
        <div class="col-12 text-center">
            <div class="tm-page-header">
                ...
                <h1 class="d-inline-block text-uppercase">Eselon 3</h1>
            </div>
        </div>
    </div>
    <!-- navbar -->
    ...
    <div class="container">
        ...
        <div class="btbh">
            <a href="BeritugasE3.php"><button type="button" class="btn btn-info">Beri Tugas</button></a>
            ...
            <div class="margin">
                ...
                <table class="table-responsive table-striped table-bordered">
                        ...
                        <tr style="height: 55px;">
                                <th style="padding-left: 25pt; padding-right: 25pt;">Kode</th>

                                <th style="padding-left: 25pt; padding-right: 25pt;">Judul</th>



                                <th style="padding-left: 100pt; padding-right: 100pt;">Note</th>
                                <th style="padding-left: 100pt; padding-right: 100pt;">Kategori</th>
                                <th style="padding-left: 25pt; padding-right: 25pt;">Date</th>

                                <th style="padding-left: 25pt; padding-right: 25pt;">Aksi</th>
                        ...
                        <tr style="width: 100pt;">
                                ...
                                <td>
                                    <a href="BeritugasE4.php"><button type="button"
                                            class=" btn btn-success" style=" width: 75px;">Edit</button></a>
                                    <a href="Ubah-barang.php?id=----belum---"><button type="button"
                                            class=" btn btn-danger" style=" width: 75px;">Delete</button></a>
                ...
                <div class="margin">
                    ...
                    <table class="table-responsive table-striped table-bordered">
                            ...
                            <tr style="height: 55px;">
                                    ...
                                    <th style="padding-left: 100pt; padding-right: 100pt;">Kategori</th>
                                    <th style="padding-left: 25pt; padding-right: 25pt;">Date</th>
                                    <th style="padding-left: 43pt; padding-right: 43pt;">Aksi</th>
                            ...
                            <tr style="width: 100pt;">
                                    ...
                                    <td>
                                        <a href="ambiltugasE4.php"><button type="button" class="btn btn-info" style=" width: 75px;">Ambil</button></a>
                ...
                <div class="margin">
                    ...
                    <table class="table-responsive table-striped table-bordered">
                            ...
                            <tr style="width: 100pt;">
                                    ...
                                    <td>date</td>
                                    <td><a href="Ubah-barang.php?id=----belum---"><button type="button"
                                                class=" btn btn-success" style=" width: 75px;">Selesai</button></a>
                    ...
                    <table class="table-responsive table-striped table-bordered">
                            <thead class="table-dark" align="center">
                                <tr style="height: 55px;">
                                    ...
                                    <th style="padding-left: 100pt; padding-right: 100pt;">Note</th>
                                    <th style="padding-left: 100pt; padding-right: 100pt;">Kategori Staff</th>
                                    <th style="padding-left: 100pt; padding-right: 100pt;">Kategori Pekerjaan</th>

                                    <th style="padding-left: 25pt; padding-right: 25pt;">Date</th>
                                    <th style="padding-left: 25pt; padding-right: 25pt;">Upload Gambar</th>
                                    <th style="padding-left: 25pt; padding-right: 25pt;">Upload Dokumen</th>
                                    <th style="padding-left: 25pt; padding-right: 25pt;">Aksi</th>
                                    <!-- <th>Harga Beli</th>
                <th>Ubah</th> -->
                                </tr>
                            ...
                            <tbody align="center">
                                ...
                                <tr style="width: 100pt;">
                                    <td width="100pt">Kode</td>
                                    
                                    <td width="100pt">Tugas</td>
                                    <td style="width:400pt;" >
                                        aLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis
                                        nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                                    </td>
                                    <td style= "width: 100px;">assddfsdfsdfsfdfddfdfdfdfdfd</td>
                                    <td width="300pt">assddfsdfsdfsfdfddfdfdfdfdfd</td>



                                    <td width="150pt">2020-02-03</td>
                                    <td width="100pt">
                                        <form action="aksi.php" method="post" enctype="multipart/form-data">
                                            <input type="file" name="file" style="width:100px;font-size:7pt;">
                                    ...
                                    <td width="100pt"><a href="Ubah-barang.php?id=----belum---"><button type="button"
                                                class=" btn btn-success" style=" width: 75px;">Submit</button></a>
                                        <!-- <a href="hapus.php?id=&status=Barang1"><button type="submit"
                            class=" btn btn-danger" onclick="Hapus()"><img src="silang.png" alt="" width="25"
                                height="25"></button></a> -->
                                    </td>
                        ...
                        <th>Ubah</th> -->
                            ...
                            <tbody align="center">
                                ...
                                <tr style="width: 100pt;">
                                    ...
                                    <td></td>
                                    <td>date</td>
                                    <td>&emsp;<a href=""><button type="button" class=" btn btn-info">Download
                                                File</button></a>
                                        <a href=""><button type="button"
                                                class=" btn btn-danger" style=" width: 130px;">Revisi</button></a>&emsp;
