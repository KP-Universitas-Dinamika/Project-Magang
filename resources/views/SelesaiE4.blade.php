                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse" id="tmMainNav">
                            ...
                            <li class="nav-item active">
                                    <a class="nav-link" href="indexE4.php">Home <span
                                            class="sr-only">(current)</span></a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="TodoE4.php">To Do</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="ProgresE4.php">Progres</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="SelesaiE4.php">Selesai</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="RevisiE4.php">Revisi</a>
                                </li>
                            </ul>
                        </div>
                    </nav>
