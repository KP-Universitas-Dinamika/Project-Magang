            ...
            <div class="margin">
                <div class="col-sm-12">
                    <form action="POST">
                        ...
                        <input type="text" class="form-control form-control-sm" placeholder="Yang dapat melihat..">
                        ...
                        <a href="indexE3.php"><button type="button" class="btn btn-success">Simpan</button></a>
                        <a href="indexE3.php"><button type="button" class="btn btn-primary">Kembali</button></a>
