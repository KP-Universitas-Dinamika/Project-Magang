...
<body>
                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse" id="tmMainNav">
                            ...
                            <li class="nav-item active">
                                    <a class="nav-link" href="indexStaf.php">Todo <span class="sr-only">(current)</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="ProgresStaf.php">Progres</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="SelesaiStaf.php">Selesai</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="RevisiStaf.php">Revisi</a>
                                </li>
                            </ul>
                        </div>
                    </nav>
    ...
    <!-- Video Banner -->
    <!-- <section class="tm-banner-section" id="tmVideoSection" style="height: 500px;">
