...
<body>
    ...
    <div class="container" id="home">
        <div class="col-12 text-center">
            <div class="tm-page-header">
                ...
                <h1 class="d-inline-block text-uppercase">Staff</h1>
            </div>
        </div>
    </div>
    <!-- navbar -->
    ...
    <div class="container">
        ...
        <div class="container-fluid" id="beritugas">
        ...
        <div class="btbh">
            <a href="BeritugasStaf.php"><button type="button" class="btn btn-info">Beri Tugas</button></a>
                    ...
                    <div class="col-sm-12">
                        <table class="table table-striped table-bordered">
                            ...
                            <tr style="width: 100pt;">
                                    ...
                                    <td>
                                        <a href="ambiltugasStaf.php"><button type="button" class="btn btn-info"
