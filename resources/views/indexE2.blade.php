...
<body>
    ...
    <div class="container" id="home">
        <div class="col-12 text-center">
            <div class="tm-page-header">
                ...
                <h1 class="d-inline-block text-uppercase">Eselon 2</h1>
            </div>
        </div>
    </div>
    <!-- navbar -->
                        ...
                        <div class="collapse navbar-collapse" id="tmMainNav">
                            <ul class="navbar-nav mx-auto tm-navbar-nav" >
                                <li class="nav-item active">
                                    <a class="nav-link" href="indexE2.php">Home <span
                                            class="sr-only">(current)</span></a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="RevisiE2.php">Revisi</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="TodoE3e2.php">ToDo Eselon 3</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="TodoE4e2.php">ToDo Eselon 4</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="TodoStafe2.php">ToDo Staff</a>
                                </li>
                            </ul>
                        </div>
                    </nav>
    ...
    <div class="container">
        ...
        <div class="btbh">
            <a href="FormberitugasE2.php"><button type="button" class="btn btn-info">Beri Tugas</button></a>
                    ...
                    <table class="table-responsive table-striped table-bordered">
                        ...
                        <tbody align="center">
                            ...
                            <tr style="width: 100pt;">
                                ...
                                <td>
                                    <a href="FormEdittugasE2.php"><button type="button" class=" btn btn-success"
                                            style=" width: 75px;">Edit</button></a>
